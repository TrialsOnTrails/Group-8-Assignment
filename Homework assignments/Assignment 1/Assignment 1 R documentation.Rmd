...
blogData_test_2012_02_02_00_00 <- read_csv("data/BlogFeedback Data Set/blogData_test-2012.02.02.00_00.csv")
#View(blogData_train)
```
...
hist(blogData_train$`281`, 10000)
boxplot(predicted)
summary(predicted)
hist(predicted, 100)
xx<-blogData_test_2012_02_02_00_00[,281]
hist(xx, x=100)
```
